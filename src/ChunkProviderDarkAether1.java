...
public class ChunkProviderDarkAether1 implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderDarkAether1(World par1World, long par2, boolean par4)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        for (int k = 0; k <2; k++)
        {
        	...
        	int y = rand.nextInt(10) + 64;
        	int z = j + rand.nextInt(16);
        	
        	(new WorldGenDungeonPower()).generate(worldObj, rand, x, y, z);
        }
    ...
    {
        if ("Stronghold".equals(par2Str) && strongholdGenerator != null && par2Str == "yololol")
        {
